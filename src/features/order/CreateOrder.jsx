        ...
        <div className='px-4 py-6'>
            ...
            <Form method="POST">
                <div className='mb-5 flex flex-col gap-2 sm:flex-row sm:items-center'>
                    ...
                    <input className="grow input" type="text" name="customer" defaultValue={username} required />
                </div>
                ...
                <div className='relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center'>
                    ...
                    {!position.lat && !position.lng &&
                        <span className='absolute z-50 right-[3px] top-[35px] md:right-[5px] md:top-[5px]'>
                            <Button
                                type="small"
                                disabled={isLoadingAddress}
                                onClick={(e) => {
...
export async function action({ request }) {
    ...
    store.dispatch(clearCart()); // useDispatch is not available outside components
